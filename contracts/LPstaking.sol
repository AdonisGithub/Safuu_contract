...
contract FurioLPStaking is Ownable {
    ...
    uint256 public accLPReflectionPerShare; //Reflection for LP holders
    ...
    function updateRewardPool() public {
        ...
        require( deltaTime >= 1 seconds, "It is available every 24hours.");
        uint256 times = deltaTime.div(1 seconds);
    ...
    function stake(uint256 _amount) public {
        ...
        totalReward += _amount.mul(50).div(1000);
    ...
    function pendingReflectionReward( address _holderAddress) external view returns (uint256 _pending) {
    ...
    function updateReflectionPool() public {
        ...
        uint256 total = LPTokenContract.totalSupply().sub(totalStakingAmount).sub(LPLockAmount);
        uint256 ReflectionPerShare = totalReflection.mul(1e18).div(total);
    ...
    function claimReflectionRewards() public {
        ...
        require(balance > 0, "Don't exist LP token!");
        require(holderAddress != LPLockReceiver, "This is LP lock address");
    ...
    function setInitialAddresses(IERC20 _LPTokenContract, address _LPLockReceiver) external onlyOwner{
        LPTokenContract = _LPTokenContract;
        LPLockReceiver = _LPLockReceiver;
    }
